...
export default function Login() {
  ...
  const hasTelegramOIDC = oauthProviders.some((p) => p.name === 'telegram');
      ...
      <div className="relative w-full max-w-md space-y-5">
        ...
        {registeredEmail ? (
          ...
          <div className="card">
            ...
            {/* Bot link at bottom */}
            {botUsername && (
              <div className="mt-6 rounded-xl border border-dark-700/30 bg-dark-800/40 px-4 py-3 text-center">
                <p className="mb-1.5 text-xs text-dark-400">{t('auth.orUseBot')}</p>
                <a
                  href={
                    referralCode
                  ...
                  className="inline-flex items-center gap-1.5 text-sm font-medium text-[#2AABEE] transition-colors hover:text-[#1E96D1]"
                >
