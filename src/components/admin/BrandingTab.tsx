    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-dark-700/50 bg-dark-800/50 p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-xl bg-dark-700/30 p-4">
            <div>
              <span className="font-medium text-dark-100">{t('admin.settings.legalFooter', 'Юридический футер')}</span>
              <p className="text-sm text-dark-400">{t('admin.settings.legalFooterDesc', 'Ссылки на оферту/политику/рекурренты внизу страницы входа')}</p>
            </div>
            <Toggle
